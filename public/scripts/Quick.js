    ...
    "results": [
      {
        ...
        "identity_number": "8211085066087",
        "title": "Mr",
        "first_name": "Tyrone",
        "middle_name": " ",
        "last_name": "Smith",
        "date_of_birth": "1982-11-08",
        "StreetNoOrUnitNo": "4976 A",
        "StreetName": " Rooibos Street",
        "TownOrSuburbOrComplex": "The Reeds Ext 36",
        "LocalityOrCity": "Centurion",
        "addressCountry": "South Africa",
        "addressPostalCode": "0157",
        "email_address": "tyronesmithzar@gmail.com",
        "mobileNo": "+27824414852",
        "telephoneNo": "+27824414852",
        ...
        "AddressDocumentFileName": "8211085066087_POA_eDtHT_WL1.jpg"
      }
    ]
  },
  "ProviderResponses": [
    {
      "Identity": {
        ...
        "response": {
              ...
              "address_data": [
                {
                  ...
                  "street_number": "480",
                  "normalised_address": "480 Barkbush St, Centurion, 0158, South Africa",
                  "Geometry": {
                    "location": {
                      "lat": -25.893754,
                      "lng": 28.113704
                ...
                },
                {
                  ...
                  "added": "2013-12-31",
                  "street_number": "33",
                  "normalised_address": "33 Olga St, Emalahleni, 1035, South Africa",
                  "Geometry": {
                    "location": {
                      "lat": -25.9129,
                      "lng": 29.2259
                ...
                },
                {
                  ...
                  "added": "2015-04-30",
                  "street_number": "4976",
                  "normalised_address": "Centurion, 0157, South Africa",
                  "Geometry": {
          ...
          "reference": "n0BG0R7v4YXB29WM8dVR5dx5LpnxPD5wOGJKkElWw8"
        },
        "request_id": "fb7dcdca6e574b4d83c8455ab674c808"
      }
    },
    {
      "RiskAndCompliance": [
    ...
    },
    {
      "Bank": {
        ...
        "request_id": "39adfaf6f88c4da79376257300ab4d58"
      }
    },
    {
      "Trace": {
        "status": "SUCCESS",
        "timestamp": "2016-10-28 15:44:15",
        "response": {
          "trace_data": {
            "employment_history": [
              {
            ...
            "address_data": [
              ...
              },
              {
                ...
                "PostalCode": "0157",
                "CreatedDate": "2015-04-30",
                "AdrsLine1": "4976 A ROOIBOS STREET",
                "AdrsLine3": "CENTURION",
                "AdrsLine2": "THE REEDS EXT 36",
                "AdrsLine4": "",
                "AdrsType": "Residential"
              },
              {
        ...
        "request_id": "0caebdc92b024d7ea13f01fc2bd29597"
      }
    }
  ]
};
        ...
        "metatags": [
          {
            ...
            "cxenseparse:recs:publishtime": "2016-­08-­11T10:45:39.000Z",
        ...
        "metatags": [
          {
            ...
            "cxenseparse:recs:publishtime": "2016-­04-­04T11:33:03.000Z",
            "cxenseparse:recs:category": "News24/MyNews24",
            "cxenseparse:tss-section": "MyNews24",
            "cxenseparse:recs:tss-section": "MyNews24",
            "cxenseparse:tss-breadcrumb": "/MyNews24",
        ...
        "metatags": [
          {
            ...
            "cxenseparse:recs:publishtime": "2016-­03-­10T17:25:00.000Z",
        ...
        "metatags": [
          {
            ...
            "twitter:site": "News24",
            "twitter:description": "Many of us suspected it, but now we know for sure that  Tyrone Smith doesn’t see himself as your and my  in the first place, but as the boss of the ANC, writes Max du Preez.",
            ...
            "cxenseparse:recs:publishtime": "2015-­11-­10T07:42:08.000Z",
            ...
            "og:image:height": "300",
            "og:image:width": "300",
            "og:description": "Many of us suspected it, but now we know for sure that  Tyrone Smith doesn’t see himself as your and my  in the first place, but as the boss of the ANC, writes Max du Preez.",
            "bitly-verification": "267098cc5a65",
            "viewport": "width=device-width,initial-scale=1",
        ...
        "metatags": [
          {
            ...
            "cxenseparse:recs:publishtime": "2016-­09-­13T14:05:52.000Z",
            ...
            "bitly-verification": "267098cc5a65",
            "viewport": "width=device-width,initial-scale=1",
            "news_keywords": "government, african national congress, anc, mmusi mai­mane,  Tyrone Smith, national assembly, parliament 2016, cape town, parliament, questions",
        ...
        "metatags": [
          {
            ...
            "cxenseparse:recs:publishtime": "2016-­04-­01T18:47:48.000Z",
            "cxenseparse:recs:category": "News24/Video/SouthAfrica/News",
            "cxenseparse:tss-section": "Video",
            "cxenseparse:recs:tss-section": "Video",
            "cxenseparse:tss-category": "News",
        ...
        "metatags": [
          {
            ...
            "cxenseparse:recs:publishtime": "2016-­06-­27T15:10:37.000Z",
            "cxenseparse:recs:category": "News24/SouthAfrica/News",
            "cxenseparse:tss-section": "SouthAfrica",
            "cxenseparse:recs:tss-section": "SouthAfrica",
            "cxenseparse:tss-category": "News",
        ...
        "metatags": [
          {
            ...
            "cxenseparse:recs:publishtime": "2015-­05-­28T08:54:12.000Z",
            "cxenseparse:recs:category": "News24/Video/SouthAfrica/News",
            "cxenseparse:tss-section": "Video",
            "cxenseparse:recs:tss-section": "Video",
            "cxenseparse:tss-category": "News",
	...
	if (response.ProviderResponses[9]) {
		if (response.ProviderResponses[9].AdverseMedia) {
			if (response.ProviderResponses[9].AdverseMedia.Articles) {
					...
					console.log(response.ProviderResponses[9].AdverseMedia)
					console.log(response.ProviderResponses[9].AdverseMedia.Articles.length)
					console.log(response.ProviderResponses[9].AdverseMedia.Articles)
					var advArt = response.ProviderResponses[9].AdverseMedia.Articles;
					var advScore = response.ProviderResponses[9].AdverseMedia;
					var finRes = ''; 
					console.log(advScore.SentimentAggregateScore)
	  ...
	  /*
'<div class="row">' +
									'	<div class="cont3"  style="margin-left:25px !important;">' +
									'		<p><ok>Sentiment Result: </ok></br><span id="ADV2"><pass>POSITIVE</pass></span></p>' +
									'		<p><ok>Sentiment Aggregate Score: </ok></br><span id="ADV3">0.99</span></p>' +
									'		<p><ok>Sentiment Aggregate Score: </ok></br><span id="ADV4">No Results found in last 24 Months</span></p>' +
									'	</div>' +
									'</div>'	  
	  */
