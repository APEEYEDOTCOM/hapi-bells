...
module silica
  ...
  class GetSystemApi
    ...
    #
    # Creates and initializes a new instance of the GetSystemApi class.
    ...
    #
    #
    def ping_api(api_key, custom_headers = nil)
      response = ping_api_async(api_key, custom_headers).value!
      nil
    end
    ...
    #
    def ping_api_with_http_info(api_key, custom_headers = nil)
      ping_api_async(api_key, custom_headers).value!
    end
    ...
    #
    def ping_api_async(api_key, custom_headers = nil)
      fail ArgumentError, 'api_key is nil' if api_key.nil?


      request_headers = {}
      path_template = 'System/API_Ping/{API_Key}/'
