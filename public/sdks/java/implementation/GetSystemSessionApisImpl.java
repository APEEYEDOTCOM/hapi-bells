 ...
 */
public class GetSystemSessionApisImpl implements GetSystemSessionApis {
    /** The Retrofit service to perform REST calls. */
    private GetSystemSessionApisService service;
    /** The service client containing this operation class. */
    private MASTERTEMPLATEImpl client;

    /**
     * Initializes an instance of GetSystemSessionApis.
     *
     * @param retrofit the Retrofit instance built from a Retrofit Builder.
     * @param client the instance of the service client containing this operation class.
     */
    public GetSystemSessionApisImpl(Retrofit retrofit, MASTERTEMPLATEImpl client) {
        this.service = retrofit.create(GetSystemSessionApisService.class);
        this.client = client;
    }

    /**
     * The interface defining all the services for GetSystemSessionApis to be
     * used by Retrofit to perform actually REST calls.
     */
    interface GetSystemSessionApisService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: silica.GetSystemSessionApis key" })
